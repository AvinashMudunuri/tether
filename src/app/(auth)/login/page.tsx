    ...
    <Suspense
      fallback={
        <div
          ...
          role="region"
        >
          <div className="h-8 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-6" />
          <div className="h-4 bg-slate-200 dark:bg-slate-700 rounded animate-pulse w-3/4 mb-4" />
